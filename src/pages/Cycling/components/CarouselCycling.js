...
export default function CarouselCycling(props) {
  const { cyclingData, carouselItems, reactScrollComponentRef, carouselComponentRef, carouselItemsRef, handleNext, handleBack } = props;
