...
export default function CarouselPilates(props) {
  const { pilatesData, carouselItems, reactScrollComponentRef, carouselComponentRef, carouselItemsRef, handleNext, handleBack } = props;
